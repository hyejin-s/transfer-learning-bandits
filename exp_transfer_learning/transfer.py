...
# from OSSB_mono_5 import OSSB, LipschitzOSSB_true
...
def main(args):
    ...
    A1, A2, A3, A4 = [0, 0, 0, 0], [dist, 0, 0, 0], [dist/2, 0, sqrt(3) * (dist/2), 0], [dist/2, 0, dist/(2*sqrt(3)), (dist*sqrt(6))/3]
    B1, B2, B3, B4 = [0, y, 0, 0], [dist, y, 0, 0], [dist/2, y, sqrt(3) * (dist/2), 0], [dist/2, y, dist/(2*sqrt(3)), (dist*sqrt(6))/3]

    embeddings = np.array([A1, A2, A3, A4, [(A1[i]+A2[i]+A3[i])/3 for i in range(len(A1))],
                       [(A1[i]+A2[i]+A4[i])/3 for i in range(len(A1))],
                       [(A1[i]+A3[i]+A4[i])/3 for i in range(len(A1))],
                       [(A2[i]+A3[i]+A4[i])/3 for i in range(len(A1))],
                       B1, B2, B3, B4, [(B1[i]+B2[i]+B3[i])/3 for i in range(len(A1))],
                       [(B1[i]+B2[i]+B4[i])/3 for i in range(len(A1))],
                       [(B1[i]+B3[i]+B4[i])/3 for i in range(len(A1))],
                       [(B2[i]+B3[i]+B4[i])/3 for i in range(len(A1))]])
