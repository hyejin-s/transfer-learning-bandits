import sys, os
sys.path.append("/home/phj/transfer-learning-bandits/policies")

from Bernolli import Bernoulli
from evaluator_transfer_learning import *
from OSSB_Transfer_hyp10 import OSSB_DEL, LipschitzOSSB_DEL, LipschitzOSSB_DEL_beta, LipschitzOSSB_DEL_true
...
def main(args):
    ...
    M = args.task # the ordering of Transfer Learning
    ...
    for m in range(M):
        ...
        for idx in range(len(POLICIES)):
            regret_transfer[idx][m] = evaluation.getCumulatedRegret_LessAccurate(policyId=idx)[args.horizon-1]
        for idx in range(len(POLICIES)):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", help="", type=str, default="")
    ...
    parser.add_argument("--task", help="M; the total number of transfer learning tasks", type=int, default=400)
