...
from OSSB_Transfer10_theta import LipschitzOSSB_DEL_beta, LipschitzOSSB_DEL_true
...
dir_name = "./non-stationary-d+Lipschitz-true-d"
...
colors = ['tomato', 'limegreen', 'deepskyblue', 'crimson', 'pink', 'mediumorchid', 'rebeccapurple', 'navajowhite', 'lavender', 'darkgrey', 'royalblue', 'darkorange', 'orange'] # 13
labels = ['inf', 'd:(0.1, 0.05)', 'd:(0.3, 0.05)', 'd:(0.5, 0.05)', 
        'L:(0.1, 0.05)', 'L:(0.3, 0.05)', 'L:(0.5, 0.05)', 'L_true', 'd_true']

# labels = ['inf', 'd:(0.1, 0.1)', 'd:(0.3, 0.1)', 'd:(0.5, 0.1)', 'd:(0.1, 0.05)', 'd:(0.3, 0.05)', 'd:(0.5, 0.05)', 
#         'L:(0.1, 0.1)', 'L:(0.3, 0.1)', 'L:(0.5, 0.1)', 'L:(0.1, 0.05)', 'L:(0.3, 0.05)', 'L:(0.5, 0.05)']
...
with open(dir_name+ "/regret_transfer.txt", "w") as f:
    for episode in range(M): 
        ...
        , regret_transfer[7, episode], regret_transfer[8, episode]))
