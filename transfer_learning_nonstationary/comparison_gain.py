...
# plt.figure()
# plt.plot(embeddings, arm_info[10], label="Episode:{}".format(10), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[20], label="Episode:{}".format(20), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[30], label="Episode:{}".format(30), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[40], label="Episode:{}".format(40), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[45], label="Episode:{}".format(45), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[177], label="Episode:{}".format(177), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[201], label="Episode:{}".format(201), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, arm_info[204], label="Episode:{}".format(204), marker='o', markersize=3, linewidth = 0.5)
# plt.legend()
# plt.savefig(filepath+'/figure-theta-arminfo', dpi=300)
# # plt.savefig(filepath+'/figure-all-test.pdf', format='pdf', dpi=300)

# plt.figure()
# plt.plot(embeddings, mu_info[10], label="Episode:{}".format(10), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[20], label="Episode:{}".format(20), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[30], label="Episode:{}".format(30), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[40], label="Episode:{}".format(40), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[45], label="Episode:{}".format(45), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[177], label="Episode:{}".format(177), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[201], label="Episode:{}".format(201), marker='o', markersize=3, linewidth = 0.5)
# plt.plot(embeddings, mu_info[204], label="Episode:{}".format(204), marker='o', markersize=3, linewidth = 0.5)
# plt.legend()
# plt.savefig(filepath+'/figure-mu-arminfo', dpi=300)
# # plt.savefig(filepath+'/figure-all-test.pdf', format='pdf', dpi=300)
...
def get_confusing_bandit_d(j, d, mu, thetas, n):
    ...
    for i, theta in enumerate(thetas):
        if i == j:
            ...
            if n == 0: # theta
                lambda_values[i] = max(theta, mu_max/embeddings[i] - d[i][j]/54)
            else: # mu
                lambda_values[i] = max(mu[i], mu_max-d[i][j]/54)/embeddings[i]
            # if lambda_values[i]>1:
            #     lambda_values[i] = theta/r[i]
    return lambda_values   
...
# plt.legend()
# plt.savefig(filepath+'/figure-theta-npinf-test', dpi=300)
# # plt.savefig(filepath+'/figure-all-test.pdf', format='pdf', dpi=300)
# print("Success to save figure-all")

# plt.figure()
# plt.plot(X, plotting_value[0]-plotting_value[1], label="classic - lip_theta_L", linewidth = 1)
# plt.legend()
# plt.savefig(filepath+'/figure-comparision-classic-theta-npinf', dpi=300)
# # plt.savefig(filepath+'/figure-all-test.pdf', format='pdf', dpi=300)
# print("Success to save figure-all")
...
# plt.legend()
# plt.savefig(filepath+'/figure-all-test', dpi=300)
# plt.savefig(filepath+'/figure-all-test.pdf', format='pdf', dpi=300)
# print("Success to save figure-all")
